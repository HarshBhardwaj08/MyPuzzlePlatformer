...
public class BlackHoleHotKey : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(hotkey))
        {
            ...
            UnityEngine.GameObject enemies = Instantiate(clone, myEnemy.transform.position, Quaternion.identity);
    ...
    public void setUpHotKey(KeyCode _myHotKey,Transform _myEnemy, BlackHoleController blackHoleController, UnityEngine.GameObject clones)
    {
        hotkey = _myHotKey;
